    ...
    <div className="w-full">
      ...
      <div className="bg-gradient-to-r from-[#FFA500] to-[#FF6F3C] py-10">
        <div className="flex flex-col justify-center items-center text-center p-10 gap-3">
          <h2 className="text-2xl font-bold text-gray-900 pb-5">
            Discover, Cook, and Share Thousands of Delicious Recipes from Around
            the World
          </h2>
          <p className="text-2xl font-light text-gray-900 pb-4">
            Quick, tasty meals for every day.
          </p>
          <button className="p-3 text-lg text-white rounded-full cursor-pointer bg-gradient-to-r from-[#E74C3C] to-[#FF4D4D] ">
            Explore Recipes
          </button>
        </div>
      </div>
            ...
            {foods.map((food) => (
              <div className="flex flex-col justify-center items-center rounded-lg shadow pb-5">
                ...
                <div className="text-center pt-4">
                  ...
                  <Link to={"/recipes"} className="bg-[#FF6F3C] mt-7 px-4 py-2 rounded-full text-white">Order</Link>
                </div>
              </div>
            ))}
          </div>
